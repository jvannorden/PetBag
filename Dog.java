// Jamila Van Norden IT 145 X4235
...
public class Dog extends Pet {
    ...
    // initialized the base characteristics of the Pet class, so that the
    // Dog class can inherit its features.
    public Dog( String petName, int petAge, int dogSpaces, int daysStay,
               int dogSpaceNumber, double dogWeight, boolean grooming) {
        // set cat spaces and amount due to zero, irrelevant to Dog Class and/or assignment.
        super("dog", petName, petAge, dogSpaces, -1, daysStay, -1);
        // Referring to the member of current objects from within the instance method or constructor.
        // I don't understand how to describe this. But,
        // public int petType = "dog";
        // is equivalent to
        // this.petType = "dog";
        // Also using "this" to call other constructors in the same class (explicit constructor invocation) throughout.
        this.petType = "dog";
    ...
    public void setDogSpaceNumber(int dogSpaceNumber) {
        ...
        // Zero is a default place holder.
...
//    if (this.grooming) {
        ...
        if( (daysStay > 1) && (petType.equalsIgnoreCase("dog")) ) {
            ...
            //TODO this isn't working properly, pets class isn't complete and daysStay is
            //TODO collected in the Pet Class  file.
            System.out.println("Grooming Available.\n Enter \"yes\" to select grooming.");
                ...
                } else if(!selectGrooming.equalsIgnoreCase("yes")) {
                    this.grooming = false;
